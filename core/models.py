...
# pip ile önce indirdik. Bu django nun uu idsinden daha kısa ve daha güzel görünümlü kısa uuid üretiyomuş.
...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Food") # ürünün başlığı
...
class Vendor(models.Model):
    ...
    varranty_period = models.CharField(max_length=100, default="100")
...
class Product(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name='category') # related_name= tersten foreign key için
...
class ProductImages(models.Model): # bir ürüne ait birden fazla resmi yükleyebilmek için sub table yaptık
